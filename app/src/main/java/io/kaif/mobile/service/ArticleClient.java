...
public abstract class ArticleClient implements ArticleService {
  @Retrofit.Builder
  public abstract static class Builder {
    ...
    public abstract ArticleClient build();
  }

  public static Builder builder() {
    return new Retrofit_ArticleClient.Builder();
  }

  public static ArticleClient create() {
    return new Retrofit_ArticleClient();
  }
}
