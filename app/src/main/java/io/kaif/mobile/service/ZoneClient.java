...
public abstract class ZoneClient implements ZoneService {
  @Retrofit.Builder
  public abstract static class Builder {
    ...
    public abstract ZoneClient build();
  }

  public static Builder builder() {
    return new Retrofit_ZoneClient.Builder();
  }

  public static ZoneClient create() {
    return new Retrofit_ZoneClient();
  }
}
