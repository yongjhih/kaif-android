...
public abstract class AccountClient implements AccountService {
  @Retrofit.Builder
  public abstract static class Builder {
    ...
    public abstract AccountClient build();
  }

  public static Builder builder() {
    return new Retrofit_AccountClient.Builder();
  }

  public static AccountClient create() {
    return new Retrofit_AccountClient();
  }
}
